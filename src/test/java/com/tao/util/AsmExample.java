...
import com.tao.method.OrgMethod;
...
public class AsmExample extends ClassLoader implements Opcodes {
    ...
    public static void main(String args[]) throws IOException, IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, InstantiationException{
        ClassReader cr = new ClassReader(OrgMethod.class.getName());
        ClassWriter cw = new ClassWriter(cr, ClassWriter.COMPUTE_MAXS);
        ClassVisitor cv = new MethodUtil(cw);
        ...
        Class<?> exampleClass = loader.defineClass(OrgMethod.class.getName(), code, 0, code.length);
        ...
        FileOutputStream fos = new FileOutputStream("E:\\test\\asm\\src\\test\\java\\com\\tao\\util\\OrgMethod.class");
        fos.write(code);
        fos.close();
    }
